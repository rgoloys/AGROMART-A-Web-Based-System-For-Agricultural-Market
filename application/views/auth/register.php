  ...
  <section id="topbar" class="topbar d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi d-flex align-items-center ms-4">
            <a href="<?php echo base_url('Seller'); ?>"><span>Start Selling</span></a>
        </i>
      <?php } ?>
      </div>
...
<div class="form-container">
   <?php echo form_open_multipart('Auth/RegisterController/register'); ?>
      ...
      <?php if($this->session->flashdata('Email_Alert')): ?>
			...
			<div class="field_container">
				<div class="row">
				   <div class="form-group col-lg-6">
						<input type="text" name="txt_fname" id="fname" placeholder="First name" class="form-control" <?php echo set_value('txt_fname'); ?> required>
                  <small><?php echo form_error('txt_fname');?></small>
					</div>
					<div class="form-group col-lg-6">
						<input type="text" name="txt_lname" id="lname" placeholder="Last name" class="form-control" <?php echo set_value('txt_lname'); ?> required>
            <small><?php echo form_error('txt_lname');?></small>
					</div>
				</div>
				<div class="form-group">
					<input type="email" name="txt_email" id="email_addr" placeholder="Email" class="form-control" required>
               <small><?php echo form_error('txt_email');?></small>
				</div>
        <div class="form-group">
				...
				<div class="row">
					<div class="form-group col-lg-6">
					<input type="password" name="txt_pass" placeholder="Password" class="form-control" id="pass1" <?php echo set_value('txt_pass'); ?> required>
               <small><?php echo form_error('txt_pass');?></small>
				</div>
				<div class="form-group col-lg-6">
					<input type="Password" name="txt_cpass" placeholder="Confirm Password" class="form-control" id="pass2" required>
               <small><?php echo form_error('txt_cpass');?></small>
				</div>
        <div class="row">
          ...
          <label>Address:</label>
            ...
            <div class="form-group col-lg-6">
              <select id="Shipping" class="form-control" name="txt_Municipality" >
                ...
                <option value="Tarlac">Camiling</option>
              </select>
            </div>
        ...
        <!-- location finder-->
        <div class="form-group">
              <p class="lfind"><button type="button" class="fcc-btn" onclick="whereAmI()">Find my location</button></p>
            ...
            <div class="form-group col-lg-6">
                <input type="text" name="lng" id="lng" placeholder="Location longitude"  <?php echo set_value('txt_Street'); ?> required readonly>
					...
					<div class="form-group" id="file_container">
                     ...
                     <input type="file" name="user_avtar" class="form-control" id="name" placeholder="Upload Photo" accept="image/*" required> <!------------------>
            ...
            <div class="agreement">
              ...
              <div class="terms" style="max-width: 800px; margin: 0 auto; padding: 20px;">
                ...
                <div class="termscheckbox">
                  ...
                  <!--<div class="termscheckbox">
                    <div class="checkB">
                      <input type="checkbox" name="agree1"  id="acceptTerms2" value="agree"  id="openButton">
                    </div>
                    <div class="label">
               ...
               <!--<input type="submit" name="submit" id="submitButton" value="submit" class="form-btn">-->
