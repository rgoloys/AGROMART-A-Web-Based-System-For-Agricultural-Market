...
<h3 style="display:flex; justify-content:center;" >Add New Product</h3><br>
...
<div class="prodInfo">
      <table style="width:800px;">
            <tbody>
              ...
              <td><input type="text" name="p_title" class="form-control" id="product_title" value="<?= $product->p_title; ?>" required>
                <small><?php echo form_error('p_title');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Description:</label></td>
              <td><input type="text" name="p_description" class="form-control" id="product_description" value="<?= $product->p_description; ?>" placeholder="Brief description" >
                <small><?php echo form_error('p_description');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Price:</label></td>
              <td><input type="number" name="p_price" id="product_price" value="<?= $product->p_price; ?>" onkeyup="updateDisplay()"> 
                <small><?php echo form_error('p_price');?></small>
              </td>
            </tbody>
            <tbody>
            <td><label>Stocks:</label></td>
              <td><input type="text" name="p_stocks" class="form-control" id="product_stocks"  value="<?= $product->p_stocks; ?>" style="width:40%;" required><input type="text"  
                name="p_stocks_Unit" class="form-control" id="product_qu"  value="<?= $product->p_stocks_Unit; ?>" placeholder="kg, pieces, pounds etc." style="width:40%;" onkeyup="updateDisplay()" required>  
                <small><?php echo form_error('p_stocks');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Variety/Brand:</label></td>
              <td><input type="text" name="p_brand" class="form-control" id="name" placeholder="ex. magnolia chicken"  value="<?= $product->p_brand; ?>" >
                <small><?php echo form_error('p_brand');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Pack size:</label></td>
              <td><input type="text" name="p_size" class="form-control" id="name" value="<?= $product->p_size; ?>"placeholder="ex. per kilo, per pcs" required>
                <small><?php echo form_error('p_size');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Color:</label></td>
              <td><input type="text" name="p_color" class="form-control" id="name" value="<?= $product->p_color; ?>" placeholder="ex. black, red, white">
                <small><?php echo form_error('p_color');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Date Planted:</label></td>
              <td><input type="date" name="date_planted" class="form-control" id="product_date_harvested"  value="<?= $product->date_planted; ?>" placeholder="Product date harvested" required>
            ...
            <tbody>
              ...
              <td><input type="date" name="Actual_harvested" class="form-control" value="<?= $product->Actual_harvested; ?>" id="product_date_harvested">
                  <small><?php echo form_error('Actual_harvested');?></small>
              </td>
            </tbody>
            <tbody>
              <td><label>Estimate Date harvested:</label></td>
              <td><input type="date" name="date_harvested" class="form-control"  value="<?= $product->date_harvested; ?>" id="product_date_harvested">
            ...
            <tbody>
              <td colspan="2">
                ...
                <select id="myDropdown" name="p_address" required> 
                  <option value="<?= $product->p_address; ?>"><?= $product->p_address; ?></option>
                  <option value=""></option>
    ...
    <div id="Pending" class="w3-container city" style="display: none">
       <div class="prodInfo">
          ...
          <tbody>
              ...
              <td><input type="file" name="p_video" id="video_file" accept="video/*"></td>
              <td><video src="<?= base_url('/upload/videos/'. $product->video_file)?>" style="width:100px; height: 70px;"></td>
              <td><input type="hidden" name="existing_video_filename" value="<?= $product->video_file; ?>"></td>
                <small><?php echo form_error('p_video');?></small>
              </td>
            </tbody>
            <tbody>
              <td><input type="hidden" name="existing_image1_filename" value="<?= $product->image1; ?>"></td>
              <td><img src="<?= base_url('/upload/images/'. $product->image1)?>" style="width:70px; height:60px;"></td>
              <td><input type="file" name="p_image1" class="form-control" id="name" placeholder="Choose image" >
                <small><?php echo form_error('p_image1');?></small>
              </td>
            </tbody>
            <tbody>
              <td> <input type="hidden" name="existing_image2_filename" value="<?= $product->image2; ?>"></td>
              <td><img src="<?= base_url('/upload/images/'. $product->image2)?>" style="width:70px; height:60px;"></td>
              <td><input type="file" name="p_image2" class="form-control" id="name" placeholder="Choose image">
                <small><?php echo form_error('p_image2');?></small>
              </td>
            </tbody>
            <tbody>
              <td> <input type="hidden" name="existing_image3_filename" value="<?= $product->image3 ?>"></td>
              <td><img src="<?= base_url('/upload/images/'. $product->image3)?>" style="width:70px; height:60px;"></td>
              <td><input type="file" name="p_image3" class="form-control" id="name" placeholder="Choose image">
                <small><?php echo form_error('p_image3');?></small>
              </td>
            </tbody>
            <tbody>
              <td> <input type="hidden" name="existing_image4_filename" value="<?= $product->image4; ?>"></td>
              <td><img src="<?= base_url('/upload/images/'. $product->image4)?>" style="width:70px; height:60px;"></td>
              <td><input type="file" name="p_image4" class="form-control" id="name" placeholder="Choose image">
                <small><?php echo form_error('p_image4');?></small>
              </td>
            </tbody>
            <tbody>
              <td><input type="hidden" name="existing_image5_filename" value="<?= $product->image5; ?>"></td>
              <td><img src="<?= base_url('/upload/images/'. $product->image5)?>" style="width:70px; height:60px;"></td>
              <td><input type="file" name="p_image5" class="form-control" id="name" placeholder="Choose image">
       ...
       <div id="Paris" class="w3-container city" style="display:none">
              ...
              <td>Latitude: <input type="text" name="lat" id ="lat" placeholder="<?php echo $product->lat ?>" > <br> Longitude:<input type="text" name="lng" id ="lng" placeholder="<?php echo $product->lng ?>" ></td>  
            </tbody>
            </table>
         ...
         <tbody>
              <td colspan="2">
                ...
                <select id="Shipping" name="p_shipping" required>
                   <option value="<?= $product->p_shipping?>">₱<?= $product->p_shipping?></option>
                ...
                <select id="functionDropdown" name="subCategory"> 
                  ...
                  value=" <?php
                      if($product->subCategory != null){
                        if($product->subCategory == 'Others'){
                          echo $product->subCategory2;
                        }else{
                ...
                <div class="hide" style=" display:flex;">
                  <div class="qrImg">
                    <label for="functionDropdown">if others please specify:</label>
                      <input type="text" id="functionDropdown" name="subCategory2" placeholder="<?= $product->subCategory; ?>">
                  </div>
                </div>
              </div>
              <br>
   ...
   <p style="text-align:center"> <b>What to add discount?</b></a></p>
    ...
    <div style="Display:flex">
        ...
        <p>Buy </p>  <input type="number" value="<?= $product->dnum; ?>" name="dnum" id ="buy" > <p>Discounted Price </p> <input type="number" value="<?= $product->dprice; ?>" name="dprice" id ="buy" >
