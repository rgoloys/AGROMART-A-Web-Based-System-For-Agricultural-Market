...
const key = 'WXaPr09ZJq6ZSNOFofJS';
      const map = L.map('map').setView([15.686141, 120.413924], 13); //starting position
...
function onMapClick(e) {
    popup
        .setLatLng(e.latlng)
        .setContent("Location clicked the map at " + e.latlng.toString())
        .openOn(map);
...
var ajax = new XMLHttpRequest();
    ...
    ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            circle.bindPopup("<table><tr><td><img src='"+imgUrl+"' width='150px' height ='100px'/> </td><td><b>" + crops + "</b></td></tr><tr><td>Shop Name:</td><td><b> " + shop + "</b></td></tr><tr><td> Product location:</td><td><b>" + adds + "</b></td></tr><tr><td> Number of Solds:</td><td><b>" + count + "</b></td></tr></table>", {
