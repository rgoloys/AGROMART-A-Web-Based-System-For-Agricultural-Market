<div class="navbar">
        ...
        <a href="<?php echo base_url();?>cancelled" style ="font-size: 18px; color: #f85a40;"><b>Cancelled</b></a>
</div>

      
<?php $hasStatus4Orders = false; ?>
<?php foreach ($order as $item): ?>
    <?php if ($item['Status'] == "Cancelled"): ?>
        <?php $hasStatus4Orders = true; ?>
       <div class="order-container" style="margin-top:20px;">
            <div class="tags" style="display:flex; justify-content: space-between;padding: 0    ; margin: 0;">
                ...
                <h4>Date cancelled: <span style="color:#008374;"><time datetime="2020-01-01"><?= date('F j, Y', strtotime($item['date_cancel'])) ?></span></h4>
...
<?php if (!$hasStatus4Orders): ?>
    <p style="text-align: center; font-size: 24px;"> <br> No Cancelled Order</p>
<?php endif; ?>
    </table>
      </div>
</div>
