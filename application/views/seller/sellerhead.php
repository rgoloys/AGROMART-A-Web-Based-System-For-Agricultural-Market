...
main .info-data, .info_data2 {
	...
	margin-bottom: 10px;
	display: grid;
	grid-template-columns: repeat(auto-fit, minmax(240px, 20px));
	grid-gap: 10px;
}
...
<body>
	...
	<!-- SIDEBAR -->
	<section id="sidebar">
		<a href="#" class="brand"><img style="width:55px; height:55px;" src="<?php echo base_url('Impact/');?>assets/img/Logoo.png" class="img-fluid" alt="" ></i> AGROMART </a>
		<ul class="side-menu">
